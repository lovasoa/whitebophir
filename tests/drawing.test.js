...
module.exports = {
  ...
  "Test Pencil"(browser) {
    ...
    board
      ...
      .drawPencilPath("#123456", [{x: 100, y: 200}, {x: 300, y: 400}])
      .drawPencilPath("#abcdef", [{x: 0, y: 0}, {x: 90, y: 120}, {x: 180, y: 0}]);
  ...
  "Test Circle"(browser) {
    ...
    browser
      .assert.visible("ellipse[cx='200'][cy='200'][rx='200'][ry='200'][stroke='#112233']")
      .refresh()
      .waitForElementVisible("ellipse[cx='200'][cy='200'][rx='200'][ry='200'][stroke='#112233']", 15000);
  ...
  "Test Cursor"(browser) {
    ...
    board
      .waitForElementVisible("@pencilTool")
      .moveCursor("#456123", 150, 200);

    board
      .assert.cssProperty("@myCursor", "transform", "matrix(1, 0, 0, 1, 150, 200)")
