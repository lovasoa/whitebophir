const { setup, teardown, TOKENS, writeBoard, withToken, rootUrl } = require("./lib/test_helper.js");
...
module.exports = {
  async beforeEach(browser, done) {
    ({ child: serverProcess, dataPath, serverUrl, tokenQuery } = await setup(browser));
    done();
  },
