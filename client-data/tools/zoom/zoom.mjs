...
(() => {
   ...
   * @param {boolean} isTouchEvent
   */
  function move(_x, _y, evt, isTouchEvent) {
    if (pressed) {
      evt.preventDefault();
   ...
   * @param {boolean} isTouchEvent
   */
  function release(_x, _y, evt, _isTouchEvent) {
    if (pressed && !moved) {
